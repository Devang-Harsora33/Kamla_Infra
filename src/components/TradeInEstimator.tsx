...
export const TradeInEstimator: React.FC<TradeInEstimatorProps> = ({ onOpenQuoteModal }) => {
  ...
  return (
    <section id="trading" className="py-20 lg:py-28 bg-white border-b border-zinc-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="p-7 rounded-2xl bg-zinc-50 border border-zinc-200 hover:border-[#18181B] transition-all flex flex-col justify-between group"
            >
              <div>
                <span className="font-heading text-3xl font-black text-[#E85D04] mb-4 block">
                  {step.num}
                </span>
                <h3 className="font-heading text-xl font-bold text-zinc-900 mb-2 group-hover:text-[#18181B] transition-colors">
                  {step.title}
                </h3>
        ...
        <div className="bg-[#09090B] text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6 bg-white text-zinc-900 rounded-2xl p-6 sm:p-7 shadow-lg">
              {submitted ? (
                <div className="text-center py-8 space-y-3">
                  <CheckCircle2 className="w-12 h-12 text-emerald-600 mx-auto" />
                  <h4 className="font-heading text-xl font-bold text-zinc-900">Appraisal Request Submitted</h4>
                  ...
                  <button
                    ...
                    className="mt-3 px-4 py-2 bg-[#18181B] text-white text-xs font-bold rounded-lg"
                  >
